...
API_KEY = "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"

API_ENDPOINT = "https://api.openai.com/v1/chat/completions"

def generate_chat_completion(messages, model="gpt-4-vision-preview", temperature=0.3, max_tokens=None):
    headers = {
